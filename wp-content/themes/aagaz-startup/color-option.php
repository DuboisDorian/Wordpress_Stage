<?php
	...
	// topbar
	$aagaz_startup_show_header = get_theme_mod( 'aagaz_startup_show_hide_topbar', false);
	...
	$aagaz_startup_stickyheader = get_theme_mod( 'aagaz_startup_enable_disable_topbar',false);
	if($aagaz_startup_stickyheader == true && get_theme_mod( 'aagaz_startup_show_hide_topbar', false) == false){
	...
	$aagaz_startup_scrolltop = get_theme_mod( 'aagaz_startup_enable_disable_scrolltop',false);
	if($aagaz_startup_scrolltop == true && get_theme_mod( 'aagaz_startup_hide_show_scroll',false) != true){
    	$aagaz_startup_custom_css .='.scrollup i{';
			$aagaz_startup_custom_css .='display:none;';
		$aagaz_startup_custom_css .='} ';
	}
    if($aagaz_startup_scrolltop == true){
    	$aagaz_startup_custom_css .='@media screen and (max-width:575px) {';
		$aagaz_startup_custom_css .='.scrollup i{';
			$aagaz_startup_custom_css .='display:block;';
		$aagaz_startup_custom_css .='} }';
	}else if($aagaz_startup_scrolltop == false){
		$aagaz_startup_custom_css .='@media screen and (max-width:575px){';
		$aagaz_startup_custom_css .='.scrollup i{';
			$aagaz_startup_custom_css .='display:none;';
		$aagaz_startup_custom_css .='} }';
	...
	// slider overlay
	$aagaz_startup_show_slider_image_overlay = get_theme_mod('aagaz_startup_show_slider_image_overlay', true);
	if($aagaz_startup_show_slider_image_overlay == false){
		$aagaz_startup_custom_css .='#slider img{';
			$aagaz_startup_custom_css .='opacity:1;';
		$aagaz_startup_custom_css .='}';
	} 
	$aagaz_startup_color_slider_image_overlay = get_theme_mod('aagaz_startup_color_slider_image_overlay', true);
	if($aagaz_startup_show_slider_image_overlay != false){
		$aagaz_startup_custom_css .='#slider{';
			$aagaz_startup_custom_css .='background-color: '.esc_attr($aagaz_startup_color_slider_image_overlay).';';
		$aagaz_startup_custom_css .='}';
	}

	// woocommerce product sale settings
	$aagaz_startup_border_radius_product_sale_text = get_theme_mod('aagaz_startup_border_radius_product_sale_text',50);
	$aagaz_startup_custom_css .='.woocommerce span.onsale {';
		$aagaz_startup_custom_css .='border-radius: '.esc_attr($aagaz_startup_border_radius_product_sale_text).'%;';
	$aagaz_startup_custom_css .='}';

	$aagaz_startup_position_product_sale = get_theme_mod('aagaz_startup_position_product_sale', 'Right');
	if($aagaz_startup_position_product_sale == 'Right' ){
		$aagaz_startup_custom_css .='.woocommerce ul.products li.product .onsale{';
			$aagaz_startup_custom_css .=' left:auto; right:0;';
		$aagaz_startup_custom_css .='}';
	}elseif($aagaz_startup_position_product_sale == 'Left' ){
		$aagaz_startup_custom_css .='.woocommerce ul.products li.product .onsale{';
			$aagaz_startup_custom_css .=' left:0; right:auto;';
		$aagaz_startup_custom_css .='}';
	}

	$aagaz_startup_product_sale_text_size = get_theme_mod('aagaz_startup_product_sale_text_size',14);
	$aagaz_startup_custom_css .='.woocommerce span.onsale{';
		$aagaz_startup_custom_css .='font-size: '.esc_attr($aagaz_startup_product_sale_text_size).'px;';
	$aagaz_startup_custom_css .='}';
