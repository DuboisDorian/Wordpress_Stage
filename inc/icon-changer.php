...
class aagaz_startup_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $aagaz_startup_Icon_Changer_array = aagaz_startup_Icon_Changer_array();
                    foreach ($aagaz_startup_Icon_Changer_array as $aagaz_startup_Icon_Changer) {
                            $icon_class = $this->value() == $aagaz_startup_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($aagaz_startup_Icon_Changer).'"></i>
                            <span class="aagaz-startup-social-class">'.esc_attr($aagaz_startup_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function aagaz_startup_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'aagaz-startup-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'aagaz_startup_icon_customize_js' );

if(!function_exists('aagaz_startup_Icon_Changer_array')){
    function aagaz_startup_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
